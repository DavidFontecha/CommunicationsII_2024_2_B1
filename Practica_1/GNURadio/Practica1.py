...
import Practica1_epy_block_1 as epy_block_1  # embedded python block
...
class Practica1(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.epy_block_1 = epy_block_1.DifferentiatorBlock()
        self.epy_block_0 = epy_block_0.blk()
        self.blocks_vector_source_x_0_1 = blocks.vector_source_f((2, 0, 8), True, 1, [])
        self.blocks_vector_source_x_0_0 = blocks.vector_source_f((2,5,8), True, 1, [])
        ...
        self.Acumulador.set_update_time(0.1)
        ...
        for i in range(1):
            self.Acumulador.set_min(i, -100)
            self.Acumulador.set_max(i, 100)
        ...
        self.connect((self.blocks_vector_source_x_0_1, 0), (self.blocks_throttle_0, 0))
        self.connect((self.blocks_vector_source_x_0_1, 0), (self.epy_block_1, 0))
